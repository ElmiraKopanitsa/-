# Данный файл создан Эльмирой Копаницей 21.02.2023 года по книге "Программируем на Пайтон" М.Доусона
# Долгожитель
# Демонстрирует текстовое поле, текстовую область и менеджер замещения Grid
from tkinter import *
class Application(Frame):
    """GIU-приложение, владеющее секретом долголетия."""
    ...
    def create_widgets(self):
        ...
        # текстовое поля для ввода пароля
        self.pw_ent = Entry(self)
        self.pw_ent.grid(row=1, column=1, sticky=W)
        # кнопка отправления значения
