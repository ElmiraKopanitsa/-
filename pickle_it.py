...
import pickle # позволяет консервировать структуры данных и сохранять их в файлах
import shelve #обеспечивает произвольный доступ к законсервированным объектам в файлах
