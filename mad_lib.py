...
class Application(Frame):
    ...
    def create_widgets(self):
        ...
        # метка и поля для ввода имени человека
        ...
        # метка и поле для ввода глагола
    ...
    def tell_story(self):
        ...
        story += person.title()
        story += " уже совсем отчаялся довершить дело всей своей жизни - поиски затерянного города, в котором по легенде, обитали "
        story += noun.title()
        story += ". Но однажды "
        story += noun
        story += " и "
        story += person.title() + " столкнулись лицом к лицу. "
        story += "Мощное, "
        story += adjectives
        story += "ни с чем не сравнимое чувство охладило душу путешественника. "
        ...
        story += person.title() + " был ими внезапно сожран. "
        story += "\nМораль? Если задумали "
        story += verb
