...
class BJ_Deck(cards.Deck):
    """Колода карт для игры в Блек-джек."""
    def populate(self):
...
class BJ_Game(object):
    ...
    def play(self):
        ...
        self.dealer.flip_first_card() # первая карта дилера переворачивается рубашкой вверх
        for player in self.players:
            print(player)
        print(self.dealer)
        ...
        self.dealer.flip_first_card() # первая карта дилера переворачивается
        if not self.still_playing:
            # все игроки перебрали, покажем только карты дилера
            print(self.dealer)
        else:
            ...
            if self.dealer.is_busted():
                ...
                # сравниваем суммы очков диллера и игроков, оставшихся в игре
                for player in self.still_playing:
